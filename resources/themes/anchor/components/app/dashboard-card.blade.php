<a href="{{ $href ?? '' }}" @if($target ?? false) target="_blank" @else wire:navigate @endif class="flex overflow-hidden relative p-5 w-full bg-white dark:bg-zinc-800 rounded-xl border duration-300 ease-out group border-zinc-200 dark:border-zinc-700 hover:scale-[1.01]">
