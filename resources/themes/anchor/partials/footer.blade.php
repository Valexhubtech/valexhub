...
<footer class="pt-10">
    <x-container>
        ...
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <div class="mb-6 text-center lg:mb-0">
                <p class="text-xs">&copy; {{ date('Y') }} valexhub, Inc. All rights reserved.</p>
            </div>

            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                <li>
                    <a href="https://www.facebook.com/valexhub__" target="_blank" class="text-zinc-600 hover:text-zinc-900">
                ...
                <li>
                    <a href="https://www.instagram.com/valexhub__" target="_blank" class="text-zinc-600 hover:text-zinc-900">
                ...
                <li>
                    <a href="https://twitter.com/valexhub_" target="_blank" class="text-zinc-600 hover:text-zinc-900">
