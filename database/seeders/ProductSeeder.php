...
class ProductSeeder extends Seeder
{
    ...
    private function seedSchoolManagement(int $categoryId): void
    {
        ...
        if ($product->wasRecentlyCreated || $product->addons()->count() === 0) {
            ...
            DB::table('product_addons')->insert([
                ['product_id' => $product->id, 'name' => 'Parent & Student Mobile App',   'module_key' => null,            'description' => 'Branded iOS & Android app for parents to track attendance, fees, and results in real time',            'price' => 120000, 'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 1, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'SMS & WhatsApp Notifications',  'module_key' => 'notifications', 'description' => 'Automated alerts for school fees, results, attendance, and announcements',                              'price' => 8000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 2, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Online Fee Payment Gateway',    'module_key' => 'invoicing',     'description' => 'Allow parents to pay school fees directly via Paystack or bank transfer from the parent portal',        'price' => 10000,  'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 3, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'CBT Exam Module',               'module_key' => null,            'description' => 'Computer-Based Testing (CBT) for internal exams and assessments with auto-grading',                    'price' => 40000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 4, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Library Management Module',     'module_key' => null,            'description' => 'Book catalog, borrowing records, fines, and student library cards',                                     'price' => 25000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 5, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Staff Training (2 days)',       'module_key' => null,            'description' => 'Comprehensive on-site training for admin staff, teachers, and management',                              'price' => 40000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 6, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
    ...
    private function seedHotelManagement(int $categoryId): void
    {
        ...
        if ($product->wasRecentlyCreated || $product->addons()->count() === 0) {
            DB::table('product_addons')->where('product_id', $product->id)->delete();
            DB::table('product_addons')->insert([
                ['product_id' => $product->id, 'name' => 'Online Booking Engine',          'module_key' => 'booking', 'description' => 'Let guests book rooms directly from your website with real-time availability',                          'price' => 15000,  'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 1, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Restaurant & Bar POS',           'module_key' => 'pos',     'description' => 'Table management, order tracking, kitchen display, and integrated billing with room accounts',          'price' => 12000,  'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 2, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Guest Self-Service Portal',      'module_key' => null,      'description' => 'Digital check-in, service requests, and room-to-guest messaging',                                       'price' => 8000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 3, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Events & Conference Booking',    'module_key' => 'booking', 'description' => 'Manage hall bookings, corporate events, catering orders, and event billing',                            'price' => 10000,  'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 4, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Branded Guest Mobile App',       'module_key' => null,      'description' => 'Custom iOS & Android app for your guests to book, pay, and request services',                          'price' => 150000, 'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 5, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Staff Training (2 days)',        'module_key' => null,      'description' => 'On-site training for front desk, housekeeping, and management staff',                                   'price' => 40000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 6, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
    ...
    private function seedPropertyManagement(int $categoryId): void
    {
        ...
        if ($product->wasRecentlyCreated || $product->addons()->count() === 0) {
            DB::table('product_addons')->where('product_id', $product->id)->delete();
            DB::table('product_addons')->insert([
                ['product_id' => $product->id, 'name' => 'Tenant Self-Service Portal',    'module_key' => null,            'description' => 'Tenants can pay rent, view their lease, raise maintenance requests, and download receipts online',     'price' => 8000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 1, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Automated Rent Reminders',      'module_key' => 'notifications', 'description' => 'SMS and WhatsApp messages sent automatically before and after rent due dates',                           'price' => 5000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 2, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Online Rent Collection',        'module_key' => 'invoicing',     'description' => 'Accept rent payments via Paystack directly into your property account with auto-reconciliation',         'price' => 7000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 3, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Agent & Commission Tracking',   'module_key' => 'staff',         'description' => 'Assign agents to properties, track viewings, and auto-calculate commissions on each lease signed',      'price' => 6000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 4, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Property Listing Website',      'module_key' => null,            'description' => 'A branded property listing site that syncs your vacancies in real time',                                'price' => 80000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 5, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Staff Training (1 day)',        'module_key' => null,            'description' => 'Hands-on training for property managers, agents, and admin staff',                                       'price' => 25000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 6, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
    ...
    private function seedPayrollHR(int $categoryId): void
    {
        ...
        if ($product->wasRecentlyCreated || $product->addons()->count() === 0) {
            DB::table('product_addons')->where('product_id', $product->id)->delete();
            DB::table('product_addons')->insert([
                ['product_id' => $product->id, 'name' => 'Biometric Attendance Integration', 'module_key' => 'staff', 'description' => 'Sync fingerprint or face recognition attendance devices with the HR system automatically',             'price' => 35000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 1, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Employee Self-Service Portal',     'module_key' => 'staff', 'description' => 'Employees can view payslips, apply for leave, and update their records without involving HR',           'price' => 8000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 2, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Training & Development Module',    'module_key' => null,    'description' => 'Track employee training, certifications, and development plans',                                        'price' => 6000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 3, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Recruitment & Onboarding Module',  'module_key' => null,    'description' => 'Manage job applications, interviews, offers, and digital onboarding for new hires',                    'price' => 8000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 4, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Staff Training (1 day)',           'module_key' => null,    'description' => 'On-site payroll and HR system training for your finance and HR teams',                                  'price' => 25000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 5, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
    ...
    private function seedInventoryPOS(int $categoryId): void
    {
        ...
        if ($product->wasRecentlyCreated || $product->addons()->count() === 0) {
            DB::table('product_addons')->where('product_id', $product->id)->delete();
            DB::table('product_addons')->insert([
                ['product_id' => $product->id, 'name' => 'E-commerce Integration',          'module_key' => 'catalog',       'description' => 'Sync your in-store inventory with your online store — orders and stock update in real time',          'price' => 12000,  'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 1, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Customer Loyalty Program',        'module_key' => 'contacts',      'description' => 'Points and reward system to drive repeat purchases and customer retention',                             'price' => 6000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 2, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'WhatsApp Receipt & Promotions',   'module_key' => 'notifications', 'description' => 'Send digital receipts and promotional offers to customers via WhatsApp after each purchase',           'price' => 5000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 3, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Advanced Analytics Dashboard',    'module_key' => 'dashboard',     'description' => 'Deep sales analytics: top products, slow movers, profit margins, and peak hours by branch',           'price' => 8000,   'price_type' => 'recurring', 'billing_cycle' => 'monthly', 'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 4, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Barcode Label Printer Setup',     'module_key' => null,            'description' => 'Hardware configuration and label template setup for your product barcodes',                            'price' => 30000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 5, 'created_at' => now(), 'updated_at' => now()],
                ['product_id' => $product->id, 'name' => 'Staff Training (1 day)',          'module_key' => null,            'description' => 'On-site POS and inventory training for cashiers, stock managers, and supervisors',                     'price' => 20000,  'price_type' => 'onetime',   'billing_cycle' => null,      'deployment_type' => 'both', 'is_active' => true, 'sort_order' => 6, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
